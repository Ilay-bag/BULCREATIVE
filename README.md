...
- **טקסט legal זעיר** (שורות תנאים קטנטנות בשולי הקריאייטיב) עלול להתפספס בסריקה —
  מודל הראייה מתקשה בטקסט נמוך-קונטרסט בגודל פיקסלים קטן. הטקסטים השיווקיים המרכזיים
  (כותרות, CTA, באדג'ים, מותג) נשמרים באמינות גבוהה. הפתרון המלא: שכבת הטקסט של שלב 2.
- רינדור הטקסט בתמונה נעשה ע"י GPT Image 2 — מדויק מאוד אך לא מובטח פיקסל-פרפקט;
  שלב 2 (הטבעת טקסט אמיתי ב-Canvas) יסגור גם את זה.
